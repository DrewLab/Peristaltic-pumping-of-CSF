...
public class Peristalsis_wave_2d {
...
// Read parameters	
  ...
  public static Model run() {
	...
	String paramsFile = modelPath + "/PeristalsisWave2dParams.txt";
    ...
    model.func("rect1").set("lower", 0.4);
    model.func("rect1").set("upper", 4.6);
    model.func("rect1").set("smooth", 0.8);
    model.func("step1").set("location", 0.07);
    model.func("an1").set("expr", "rect1(mod(x,10))");
    model.func("an1").set("plotargs", new String[][]{{"x", "-40", "40"}});
    ...
    model.component("comp1").geom("geom1").feature("r1").set("size", new int[]{10, 1});
    ...
    String varFile2 = modelPath + "/PeristalsisWave2dBC.txt";
    ...
    model.component("comp1").view("view1").axis().set("xmin", -1.9000000953674316);
    model.component("comp1").view("view1").axis().set("xmax", 11.899999618530273);
    model.component("comp1").view("view1").axis().set("ymin", -1.5);
    model.component("comp1").view("view1").axis().set("ymax", 2.5);
	...
	model.study("std1").feature("time").set("tlist", "range(0,1,9) range(10,0.01,20)");
    ...
    model.sol("sol1").feature("v1").set("clist", new String[]{"range(0,1,9) range(10,0.01,20)", "0.001[s]"});
    ...
    model.result().export("data1").set("innerinput", "manualindices");
    model.result().export("data1").set("solnumindices", "range(11,1,1010)");
    ...
    model.result().export("data1")
         .set("filename", modelPath + "/wave2dResults.txt");
    model.result().export("data1").set("location", "grid");
    model.result().export("data1").set("gridx2", "range(0,10/200,10)");
