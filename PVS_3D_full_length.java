...
public class PVS_3D_full_length {
  ...
  public static Model run() {
	...
	model.label("PVS_3D_full_length.mph");
	
	//create parameters
	String paramsFile = modelPath + "/Peristalsis_3D_full_params.txt";
    ...
    model.result().export("data1").set("filename", modelPath + "/pvsFullLengthResults.txt");
